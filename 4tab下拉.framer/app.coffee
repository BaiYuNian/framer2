...
markScrollControl = ->
	if page.content.x <= addnumb0  && page.content.x >= -375 + addnumb0 + 187.5
		...
		tabMask.x = Utils.modulate(page.content.x, [-375+ addnumb0 + 187.5, -375+ addnumb0], [139, 178-4+29.5])
