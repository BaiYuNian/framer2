...
# gzt.placeBehind(tabMark)
# nav1.placeBehind(gzt)		
...
fllowsecond.addPage layerf8
fllowsecond.addPage layerf9
fllowsecond.addPage layerf10
...
#关注二级导航初始化
tabContentTexts1 = ["全部关注", "最新微博", "特别关注", "好友圈", "原创", "名人", "视频", "同学", "同事", "朋友"]
...
tabContents1.subLayers[7].on Events.Click, ->
	fllowsecond.snapToPage(layerf8)

tabContents1.subLayers[8].on Events.Click, ->
	fllowsecond.snapToPage(layerf9)
	
tabContents1.subLayers[9].on Events.Click, ->
	fllowsecond.snapToPage(layerf10)						
...
navd1.on Events.Click, (e) ->
	if add1.rot
		add1.animate
			rotation: 45
		add1.rot = false
		fllowsecond.scrollHorizontal = true
# 		print 1
	else
		add1.rot = true
# 		print 2	
...
navd.on Events.Click, (e) ->
	if add.rot
		add.animate
			rotation: 45
		add.rot = false
		hotsecond.scrollHorizontal = true
# 		print 1
	else
		add.rot = true
# 		print 2	
...
# 	else if this.currentPage == fllowsecond
